...
int main(int argc, char** argv) {
	...
	cl::Program program = OpenCL::loadProgramSource(context, "D:/UNIVERSITY_OF_STUTTGART/COURSES_MATERIAL/SEM4/GPU_LAB/Opencl-ex1/Opencl-ex1/src/OpenCLExercise1_Basics.cl");
